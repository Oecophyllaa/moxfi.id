...
public class AdminRegister extends javax.swing.JFrame {
    ...
    private void btn_registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registerActionPerformed
        ...
        try {
            String sql = "INSERT INTO user VALUES (default,'1','"+nama+"','"+email+"','"+user+"','"+pass+"') ";
            Connection conn = (Connection) database.getConn();
            PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(null, "Admin Baru Berhasil Ditambahkan");
