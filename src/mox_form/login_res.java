 ...
 * @author fatkh
 */
public class login_res extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_res.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
